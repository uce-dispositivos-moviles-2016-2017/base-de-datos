...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 5;//version de la base de datos
    private static String DATABASE_NAME = "NoteU2.db";//nombre de la base de datos
    private static String DATABASE_FILE = "NoteU.db";//nombre del archivo que contiene la esructura de la base
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + Constants.TABLE_STUDENTS);
    ...
    public SQLiteDatabase getWritableDatabase() {
        return SQLiteDatabase.openDatabase(DB_PATH + DATABASE_NAME, null, SQLiteDatabase.OPEN_READONLY);
    }
}
